...
import { convertIsRidingSelfFilter } from '@artifex/pack/content/server-entity/convertors/filters/is-riding-self-filter';
...
describe('convertIsRidingSelfFilter', () => {
  it('returns test-only filter when value is omitted', () => {
    expectFilter(convertIsRidingSelfFilter, {}, {
      test: 'is_riding_self',
    });
  });
