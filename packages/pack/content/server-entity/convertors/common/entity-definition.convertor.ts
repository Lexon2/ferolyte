...
export const convertSingleEntityDefinition = (
  ...
  if (definition.maxDist !== undefined) {
    if (
      !validateNumber(definition.maxDist, 'maxDist', undefined, undefined, ctx)
    ) {
      return undefined;
    }
  ...
  if (definition.maxFlee !== undefined) {
    if (
      !validateNumber(definition.maxFlee, 'maxFlee', undefined, undefined, ctx)
    ) {
      return undefined;
    }
  ...
  if (definition.checkIfOutnumbered !== undefined) {
    if (
      !validateBoolean(definition.checkIfOutnumbered, 'checkIfOutnumbered', ctx)
    ) {
      return undefined;
    }
  ...
  if (definition.mustSeeForgetDuration !== undefined) {
    if (
      !validateNumber(
        definition.mustSeeForgetDuration,
        'mustSeeForgetDuration',
        undefined,
        undefined,
        ctx,
      )
  ...
  if (definition.reevaluateDescription !== undefined) {
    if (
      !validateBoolean(
        definition.reevaluateDescription,
  ...
  if (definition.sprintSpeedMultiplier !== undefined) {
    if (
      !validateNumber(
        definition.sprintSpeedMultiplier,
  ...
  if (definition.walkSpeedMultiplier !== undefined) {
    if (
      !validateNumber(
        definition.walkSpeedMultiplier,
        'walkSpeedMultiplier',
        undefined,
        undefined,
        ctx,
